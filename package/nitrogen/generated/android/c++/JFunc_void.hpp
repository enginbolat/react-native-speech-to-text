...
namespace margelo::nitro::speechtotext {
  ...
  public:
    static auto constexpr kJavaDescriptor = "Lcom/margelo/nitro/speechtotext/Func_void;";
  ...
  public:
    static auto constexpr kJavaDescriptor = "Lcom/margelo/nitro/speechtotext/Func_void_cxx;";
