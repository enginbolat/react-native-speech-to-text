...
namespace margelo::nitro::speechtotext {
  ...
  public:
    static auto constexpr kJavaDescriptor = "Lcom/margelo/nitro/speechtotext/Func_void_double;";
  ...
  public:
    static auto constexpr kJavaDescriptor = "Lcom/margelo/nitro/speechtotext/Func_void_double_cxx;";
